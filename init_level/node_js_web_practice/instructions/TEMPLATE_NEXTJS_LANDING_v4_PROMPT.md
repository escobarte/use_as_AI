...
# HOW TO USE:
#   1. Fill in TEMPLATE_NEXTJS_LANDING_v4_PROJECT.md
#   2. Open Claude Code → type: Read TEMPLATE_NEXTJS_LANDING_v4_PROMPT.md
...
Read TEMPLATE_NEXTJS_LANDING_v4_PROJECT.md for project content.
