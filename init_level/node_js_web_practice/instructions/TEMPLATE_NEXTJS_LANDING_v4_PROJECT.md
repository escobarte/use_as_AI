# PROJECT CONFIG — Landing Page
# Fill this file for each new project. No instructions here — just your data.
...
### Assets
# Mark each file as READY or PENDING
# Claude will use next/image for READY files and a labeled placeholder div for PENDING
```
Logo:         [ READY /public/assets/logo.png ] or [ PENDING ]
Hero image:   [ READY /public/assets/hero-bg.jpg ] or [ PENDING ]
Section image:[ READY /public/assets/section-img.jpg ] or [ PENDING ]
```
